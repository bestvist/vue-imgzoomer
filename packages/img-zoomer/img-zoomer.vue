    ...
    methods: {
        initTime() {
            ...
            this.cover.style.width =
                this.imgbox.offsetWidth / this.scale + "px";
            this.cover.style.height =
                this.imgbox.offsetHeight / this.scale + "px";
            ...
            this.img.onload = () => {
                ...
                (this.imgTimesX = this.img.width / this.imgwrap.offsetWidth),
                    (this.imgTimesY =
                        this.img.height / this.imgwrap.offsetHeight);
        ...
        mousemove(e) {
            ...
            let startX =
                    pos.x -
                    (imgwrap.left - document.documentElement.scrollLeft),
                startY =
                    pos.y - (imgwrap.top - document.documentElement.scrollTop);
            this.ctx.drawImage(
                this.img,
